        ...
        <div className="contact-grid">
          <div className="contact-info glass reveal">
            ...
            <div className="social-grid">
              <a href="https://github.com/Bhavyasri-vakkalagadda" target="_blank" rel="noopener noreferrer" className="social-link">
              ...
              <a href="https://www.linkedin.com/in/bhavya-sri-vakkalagadda-928739360/" target="_blank" rel="noopener noreferrer" className="social-link">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
