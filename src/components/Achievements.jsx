  ...
  const sections = [
    {
      title: 'Education',
      items: [
        { name: 'Diploma in Computer Engineering', org: 'Kallam haranadhareddy institute of technology', period: 'CGPA: 8.82 | (2026)' },
        ...
        <div className="achievements-grid">
          ...
          <div className="achievement-card github-card glass reveal">
            ...
            <a
              ...
              title="Bhavya Sri Vakkalagadda GitHub Profile"
              aria-label="View Bhavya Sri Vakkalagadda's GitHub Profile"
            >
